...
let rawdata = fs.readFileSync('/Users/vitormateus/Documents/BotKitDialogFlowExemple/botkit-middleware-dialogflow/src/chatbotbrq-9245e14889ef.json');
const keyFile = JSON.parse(rawdata);
